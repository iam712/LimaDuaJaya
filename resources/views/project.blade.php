...
@section('content')
    ...
    <section class="py-3 py-md-4 py-lg-5 mt-5 mt-md-3 mt-lg-5 parallax"
        ...
        <h1 class="text-center mt-5 mt-md-3 mt-lg-5 fw-bold fade-section">{{ __('messages.projecttitle') }}</h1>
        <div class="container fade-section">
            @if ($projects->isEmpty())
                <h5 class="text-lg text-center text-dark p-5">{{ __('messages.errproject') }}</h5>
            @else
