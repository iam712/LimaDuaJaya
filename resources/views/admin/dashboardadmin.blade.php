...
@section('content')
<div>
    <section class="py-3 py-md-3 py-lg-2 mt-2 mt-md-3 mt-lg-2 ms-2 ms-md-2 ms-lg-2" style="background-color: transparent;">
        <h1 class="display-4" style="color: rgba({{ $color4 }}, 1);">Welcome to Admin Dashboard</h1>
        <p class="lead" style="color: rgba({{ $color3 }}, 1);">Hello, <span class="font-weight-bold"
                style="color: rgba({{ $color2 }}, 1);">user123</span>!</p>
    </section>

    <section style="background-color: rgba({{ $color5 }}, 1);">
        <div class="container">
            <div class="row">
                <!-- Card 1: Workshop -->
                <div class="col-12 col-md-6 col-lg-6 mb-4">
                    <div class="card border-light shadow-sm h-100" style="background-color: rgba({{ $color5 }}, 1);">
                        <div class="card-body">
                            <h5 class="card-title">
                ...
                <div class="col-12 col-md-6 col-lg-6 mb-4">
                    <div class="card border-light shadow-sm h-100" style="background-color: rgba({{ $color5 }}, 1);">
                        <div class="card-body">
                            ...
                            <p class="card-text" style="color: rgba({{ $color3 }}, 1);">View and manage all project
                                submissions and statuses.</p>
                ...
                <div class="col-12 col-md-6 col-lg-6 mb-4">
                    <div class="card border-light shadow-sm h-100" style="background-color: rgba({{ $color5 }}, 1);">
                        <div class="card-body">
                            ...
                            <p class="card-text" style="color: rgba({{ $color3 }}, 1);">Moderate and respond to user
