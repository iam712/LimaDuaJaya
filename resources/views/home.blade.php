        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 mt-1 mt-sm-1">
                    ...
                    <p style="font-family: 'LibreBaskerville', serif;">We are a company dedicated to providing the best
                        service. Our team is experienced and highly skilled.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center text-center mt-2">
                @for ($i = 0; $i < 12; $i++)
                    <div class="col-6 col-md-2 mb-2 mb-sm-2">
                        ...
                        <span class="mt-3 mt-sm-3" style="font-family: 'LibreBaskerville', serif;">service
                            {{ $i + 1 }}</span>
                    </div>
                @endfor
            </div>
            ...
            <div class="row justify-content-center mt-5 text-center">
                @for ($i = 0; $i < 12; $i++)
                    <div class="col-6 col-md-2 mb-4">
                        <img src="{{ asset('images/logo.png') }}" alt="Logo" class="img-fluid">
                        <span class="mb-4" style="font-family: 'LibreBaskerville', serif;">client
                            {{ $i + 1 }}</span>
                    </div>
                @endfor
            </div>
